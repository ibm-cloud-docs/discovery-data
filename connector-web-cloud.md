...
Before creating a web crawl collection, contact the website owner to get permissions for crawling the website. Currently, the managed deployment of {{site.data.keyword.discoveryshort}} cannot crawl [www.ibm.com](www.ibm.com){: external}.
{: important}
