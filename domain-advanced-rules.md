...
Removal of support dates differ based on the deployment type:

-   ![IBM Cloud only](images/ibm-cloud.png) **{{site.data.keyword.cloud_notm}}**: 30 June 2022
-   ![Cloud Pak for Data only](images/desktop.png) **{{site.data.keyword.icp4dfull_notm}}**: {{site.data.keyword.icp4dfull_notm}} release 4.0.9 on 25 May 2022.
