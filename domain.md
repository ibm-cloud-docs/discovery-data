...
| Recognizes entities that you identify as being significant by training an entity extractor machine learning model. | [Entity extractor](/docs/discovery-data?topic=discovery-data-entity-extractor) | Generally available for installed deployments and available as a beta feature for managed deployments. |
