...
{{site.data.keyword.knowledgestudioshort}} support for building models with the beta Advanced Rules Editor will end on 12 May 2022. Any rules models that are exported from {{site.data.keyword.knowledgestudioshort}} before that date can continue to be run in {{site.data.keyword.discoveryshort}} after that date.
{: note}
