...
Data can be labeled using the API, or using the {{site.data.keyword.discoveryshort}} tooling. For more information about labeling with the tooling, see [Labeling data with the Discovery tooling](#labelingtooling).
