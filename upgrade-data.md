...
-   From a 5.3.x release to a later 5.3 release. For more information, see [Upgrading Watson Discovery](https://www.ibm.com/docs/SSNFH6_5.3.x/svc-discovery/discovery-upgrade.html){: external}.
-   From a 5.1.x or 5.2.x release to the latest 5.3 release. For more information, see [Upgrading Watson Discovery](https://www.ibm.com/docs/SSNFH6_5.3.x/svc-discovery/discovery-upgrade.html){: external}.
