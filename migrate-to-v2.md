...
-   At the entity enrichment level, the following information is not supported in v2:
    ...
    ![Difference in entities data structure](images/compare-result-syntax.png){: caption="Figure 1. Entities data structure differences" caption-side="bottom"}
...
-   Instead of the `count` and `relevance` in v1, v2 includes the mentions. 
    ...
    ![Mentions in {{site.data.keyword.discoveryshort}} v2](images/result-detail.png){: caption="Figure 2. Entity mentions in Discovery v2" caption-side="bottom"}
