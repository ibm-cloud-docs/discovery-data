...
![Shows where the documentation search field is situated at the start of the page](images/search-doc.png){: caption="Search bar for this product documentation versus all IBM Cloud docs" caption-side="bottom"}
...
![Shows the main My Projects page with a single Sample Project tile.](images/gs-home-page.png){: caption="Discovery v2 home page" caption-side="bottom"}
