...
| Domain-specific | Relates to terms and concepts that have special meaning to an industry or business. In tennis, for example, the term *love* has a special meaning. It represents a zero score. If you built a tennis-related application, you would teach {{site.data.keyword.discoveryshort}} that the term *love* has a meaning that is different from the generally-understood meaning in the domain of tennis. |
