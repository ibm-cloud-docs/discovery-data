...
-  PDF files that are secured with a password or certificate are not supported. Only images of the supported image file types in the PDF are rendered. Vector objects, such as SVG images, and multiple-page image files are not.
