...
Any PDF files that you upload as part of an archive file are not displayed in the advanced PDF view of a query result. If you want to use the PDF view, reimport the PDF file by itself.
{: note}
