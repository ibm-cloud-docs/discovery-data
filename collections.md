...
Any PDF files that you upload as part of an archive file do not display properly from the advanced view of a query result that is opened from the *Improve and Customize* page.
{: note}
