...
PDF files that you upload as part of an archive file are not displayed in the advanced PDF view for a query result that you open from the *Improve and customize* page. If you want the file to be viewable from the PDF view, reimport the PDF file separately from the archive file.
{: note}
