...
-  PDF files that are secured with a password or certificate are not supported. Only images of the supported image file types in the PDF are rendered. Vector objects, such as SVG images, are not supported.
